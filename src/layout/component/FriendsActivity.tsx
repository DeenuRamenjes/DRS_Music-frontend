      ...
      <ScrollArea className="flex-1">
        <div className='p-4 space-y-4'>
		  ...
		  return(
            <div
              key={user._id}
              className="curser-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group"
              >
                <div className="flex items-start gap-3">
                  <div className="relative">
                    <Avatar className="size-10 border border-zinc-800">
                      <AvatarImage src={user.imageUrl} alt={user.name} className="rounded-full" />
